...
<div class="container">
    ...
    <table class="table table-hover">
       ...
       <tr>   <th>手数料</th><td><%=detail.getOrderCommission()%></td> </tr>
...
　     <tr>     <th>注文受付日</th><td><%=detail.getOrderDate()%></td> </tr>
	...
	<thead>
        <tr>
　        <th><a href=""><button type="button" class="btn btn-default btn-sm">取消</button></th>
          <th><a href=""><button type="button" class="btn btn-default btn-sm">訂正</button></th>
