...
　        <th>取消</th>
	 ...
	 <tbody>
		...
		<tr>
			...
			<td><a href="StockDetail?code=<%=order.getStockCode()%>"><%=order.getStockName()%></td>
			<td><a href="StockDetail?code=<%=order.getStockCode()%>"><%=order.getStockCode()%></td>
			...
			<td><a href=""><button type="button"
						class="btn btn-default btn-sm">訂正</button>
					</p></td>
			</td>
		</tr>
